...
<body>
	...
	<a href="usuariosadm.php" class="limpar-filtro">Limpar filtro</a>
	</form>
...
if (mysqli_num_rows($resultado) > 0) {
	foreach ($resultado as $aluguel) {
		echo '<tr>';
		echo '<td>' . htmlspecialchars($aluguel["nome"]) . '</td>';
		echo '<td>' . htmlspecialchars($aluguel["ap"]) . '</td>';
		echo '<td>' . htmlspecialchars($aluguel["email"]) . '</td>';
		echo '<td>' . htmlspecialchars($aluguel["tipo"]) . '</td>';
		echo '</tr>';
	}
} else {
